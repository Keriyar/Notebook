...
<img src="https://keriyar-images.oss-cn-qingdao.aliyuncs.com/img/202311192336586.png" alt="image-20231119233609544" style="zoom:50%;" />
...
​		①朴素Dijkstra算法，O($n^2$)，n是点的数量，适合稠密图(边数很多，远大于节点数,$m>n^2$, m是$n^2$级别的)，用邻接矩阵来存
...
<img src="https://keriyar-images.oss-cn-qingdao.aliyuncs.com/img/202311161916333.png" alt="image-20231116191604236" style="zoom:50%;" />
...
<img src="https://keriyar-images.oss-cn-qingdao.aliyuncs.com/img/202311201832908.png" alt="img" style="zoom:67%;" />
...
​	(1)朴素版的Prim，O($n^2$)，适用于稠密图

​	(2)堆优化版的Prim，O($mlogn$)，适用于稀疏图
...
将所有边按权重从小到大排序，依赖sort函数，所以其时间复杂度的上限就是sort的复杂度$mlogm$。

枚举每一条边a，b，边权c，如果ab不连通，就将这条边加入到集合中

用到了并查集的知识。

<img src="https://keriyar-images.oss-cn-qingdao.aliyuncs.com/img/202311212134719.png" alt="image-20231121213454618" style="zoom:50%;" />
...
<img src="https://keriyar-images.oss-cn-qingdao.aliyuncs.com/img/202311232006334.png" style="zoom:50%;" />
...
<img src="https://keriyar-images.oss-cn-qingdao.aliyuncs.com/img/202311232009017.png" alt="image-20231123200926965" style="zoom:50%;" />
...
[算法学习笔记(5)：匈牙利算法 - 知乎 (zhihu.com)](https://zhuanlan.zhihu.com/p/96229700)

匈牙利算法主要用于解决一些与**二分图匹配**有关的问题：求二分图的**最大匹配数**和**最小点覆盖数**。
...
<img src="https://keriyar-images.oss-cn-qingdao.aliyuncs.com/img/202311232030136.png" alt="image-20231123203030923" style="zoom:50%;" />

例题：

<img src="https://keriyar-images.oss-cn-qingdao.aliyuncs.com/img/202311232033186.png" alt="image-20231123203316127" style="zoom:50%;" />
...
![img](https://keriyar-images.oss-cn-qingdao.aliyuncs.com/img/202311241414502.png)
...
$$
3^{10}=9^5=9^4 \times9^1 =81^2 \times 9^1=6561^1 \times 9^1 
=6561^0 \times 6561^1 \times 9^1=59049
$$
...
<img src="https://keriyar-images.oss-cn-qingdao.aliyuncs.com/img/202311241518920.png" alt="image-20231124151834813" style="zoom:60%;" />
